...
\end{array}\right]$$
with respect to the basiss ${\cal V}$ and ${\cal V}'$ respectively.
}
...
\end{array}\]
The last table shows, that the new basis is $\{\mathbf{y}_1,\mathbf{y}_2,\mathbf{e}_3,\mathbf{e}_4\}$ and the $\mathbf{y}_3$ can be expressed as a linear combination of $\mathbf{y}_1\quad\mbox{and}\quad\mathbf{y}_2,$ namely

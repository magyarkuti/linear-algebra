...
The number of components in $\mathbf{v}$, which is $n-r$ is called the \alert{degree of freedom} of the linear system of equations.
...
\begin{frame}\frametitle{Two-sidedness}
    The special case of this theorem becomes ipmortant soon, when we discuss the concept of the inverse matrix.
    \begin{theorem}
...
\begin{frame}\frametitle{Summary}
    ...
    \begin{itemize}
        ...
        \item The columns if $A$ span $\mathbb{R}^n$,

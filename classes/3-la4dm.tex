...
\begin{frame}\frametitle{Kernel and nullity}
    ...
    The column space (the range of $A$) is a subspace of $\mathbb{R^m}$; 
    the row space is the subspace of $\mathbb{R}^n$; 
    and the kernel of $A$ which is also a subspace of $\mathbb{R}^n$.
    ...
    then the kernel coincides with the solution set of the system.
\end{frame}
